...
class _ViewerState extends State<Viewer> {
  ...
  void _onDocumentViewCreated(DocumentViewController controller) async {
    ...
    var customToolbar = CustomToolbar('Pen', 'Pen', [Tools.annotationCreateFreeHand, Tools.eraser, Buttons.editAnnotationToolbarButton], ToolbarIcons.pens);
    config.annotationToolbars = [DefaultToolbars.view, DefaultToolbars.annotate, DefaultToolbars.draw, customToolbar, DefaultToolbars.favorite];
